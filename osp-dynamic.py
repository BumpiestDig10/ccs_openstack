...
class OSDynSliceManagerHelper(protogeniclientlib.DynSliceManagerHelper,
    ...
    def _initStateFromParameters(self):
        ...
        # All releases use Ubuntu 22.04 LTS
  ...
  - *%s*
    ...
    (default value: *%s*)
        ...
        tourDescription = \
  "This profile provides a highly-configurable OpenStack instance with a controller, network manager, and one or more compute nodes (potentially at multiple Cloudlab sites). This profile runs x86 or ARM64 nodes. It sets up OpenStack Antelope or Zed on Ubuntu 22.04 LTS, and configures all OpenStack services, pulls in some VM disk images, and creates basic networks accessible via floating IPs. You'll be able to create instances and access them over the Internet in just a few minutes. When you click the Instantiate button, you'll be presented with a list of parameters that you can change to control what your OpenStack instance will look like; **carefully** read the parameter documentation on that page (or in the Instructions) to understand the various features available to you."
